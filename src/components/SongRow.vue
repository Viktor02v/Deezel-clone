...
<template>
	<li class="flex items-center justify-between p-2 hover:bg-[#979797] hover:bg-opacity-5" @mouseenter="isHover = true"
		...
		<div class="flex items-center">
			...
			<div v-if="track"
				...
				class="text-sm pl-4 cursor-pointer mr-4">
				{{ track.id }}
			</div>
			...
			<div class="relative">
				...
				<img width="37" class="border border-[#494949]" :src="track.songCover">
			</div>
